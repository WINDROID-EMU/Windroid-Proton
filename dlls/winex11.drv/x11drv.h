...
extern void X11DRV_SetDeviceClipping( PHYSDEV dev, HRGN vis_rgn, HRGN clip_rgn );
...
extern float get_fsr_ratio(void);
...
struct x11drv_win_data
{
    ...
    UINT        is_fsr_scaled : 1; /* is the window being scaled by FSR hack */
